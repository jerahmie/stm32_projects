...
dump_rcc(void) {
        ...
        static const struct bdesc rcc_ahb1enr[] = {
                { 31, 21, Binary, 21, "res" },
        ...
        dump_reg(&RCC_AHB1ENR,"RCC",0,"AHB1ENR",rcc_ahb1enr,12);
...
dump_gpio(void) {
        ...
        dump_reg(&GPIOA_MODER,"GPIOA",0,"CRL",gpiox_crlh,16);
        dump_reg(&GPIOB_MODER,"GPIOB",0,"CRL",gpiox_crlh,16);
        dump_reg(&GPIOC_MODER,"GPIOC",0,"CRL",gpiox_crlh,16);
        dump_reg(&GPIOD_MODER,"GPIOD",0,"CRL",gpiox_crlh,16);
